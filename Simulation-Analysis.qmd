...
print((exp(1^2) + 2) * sqrt(exp(1^2)-1))
sapply(sample_sizes, analysis, f = mean, distro = rlnorm, mu = 0, sigma = 1)
sapply(sample_sizes, analysis, f = mean, distro = rlnorm, mu = 0, sigma = 0.5)
sapply(sample_sizes, analysis, f = mean, distro = rlnorm, mu = 0, sigma = 0.25)
sapply(sample_sizes, analysis, distro = rnorm, f = mean)
```
